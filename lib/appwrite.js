...
export const config = {
  ...
  databaseId: "6672f2710012bb6e0929",
  userCollectionId: "6672f283002da4cd8043",
  videoCollectionId: "6672f29f003e6c84b6b9",
  storageId: "666c72cd0038c996fde2",
  savedPostsCollectionId: "6672f47f0025e1b6a457",
};
...
export const deleteVideo = async (docId) => {
  try {
    ...
    // Fetch saved posts associated with this video post
    ...
    // Delete each saved post document
